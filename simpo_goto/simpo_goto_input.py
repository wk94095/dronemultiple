...
#print(vehicle.location.global_relative_frame.lat)  #顯示無人機經緯度高度

# time.sleep(1)
# print("Going towards second point for 30 seconds (groundspeed set to 5 m/s) ...")
# point2 = LocationGlobalRelative(23.702596, 120.423282, 20)
